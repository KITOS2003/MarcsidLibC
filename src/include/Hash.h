...
// wrapper macros
#define HashTable_create(table_size, seed) _HashTable_create(table_size, seed, malloc, realloc, free)
#define HashTable_create_allocator(table_size, seed, malloc, realloc, free) _HashTable_create(table_size, seed, malloc, realloc, free)
