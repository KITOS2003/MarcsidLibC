...
#define Darray_push_middle_multiple(data_p, index, arr, n) _Darray_push_middle_multiple((void**)data_p,index,arr,n)

void _Darray_pop_middle_multiple(void **, size_t, void *, size_t);
#define Darray_pop_middle_multiple(data_p, index, out, n) _Darray_push_middle_multiple((void**)data_p,index,arr,n)

void _Darray_push_beg(void **, void *);
#define Darray_push_beg(data_p, element) _Darray_push_beg((void**)data_p, element)
...
#define Darray_push_beg_multiple(data_p, array, n) _Darray_push_beg_multiple((void**)data_p, array, n)

void _Darray_pop_beg_multiple(void **, void *, size_t);
#define Darray_pop_beg_multiple(data_p, out, n) _Darray_pop_beg_multiple((void**)data_p, out, n)
...
#define Darray_merge_middle(data_p1, data2, index) _Darray_merge_middle((void**)data_p1, data2, index)

void _Darray_merge_beg(void **, void *, size_t);
#define Darray_merge_beg(data_p1, data2, index) _Darray_merge_beg((void**)data_p1, data2, index)

void *Darray_split(void *data, size_t start_index, size_t end_index);

void Darray_print(void *data, const char * const format, void (*print_func)(void*) );
